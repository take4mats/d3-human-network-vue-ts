  ...
  <v-container>
    <v-expansion-panels focusable popout multiple v-model="panel">
      ...
      <v-expansion-panel>
        ...
        <v-expansion-panel-content id="graph-surrounding">
          <v-container>
...
import { d3Render } from "@/plugins/d3-rendering";
...
export default defineComponent({
  ...
  watch: {
    graph(newGraph) {
      ...
      d3Render(JSON.parse(localStorage.humanNetworkGraph));
    },
  },
